            ...
            <div class="card-body p-4">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="您的名稱">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" placeholder="至少8碼">
                    </div>
                    <button type="button" class="btn btn-dark w-100" onclick="location.href='login.jsp'">註冊</button>
                </form>
                <hr>
